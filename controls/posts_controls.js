...
const getAllPosts = async (req, res) => {
  try {
    ...
    res.status(500).json({ message: "erro occured " + err.message });
  }
};
...
const deletePost = async (req, res) => {
  if (req.params.id) {
    ...
    try {
      ...
      res.status(404).json({ message: "post not found " + err.message });
    }
  }
};

module.exports = { getAllPosts, commentOnPost, addPost, deletePost };
